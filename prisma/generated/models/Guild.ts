...
export type GuildWhereInput = {
  ...
  isPublic?: Prisma.BoolFilter<"Guild"> | boolean
...
export type GuildScalarWhereWithAggregatesInput = {
  ...
  isPublic?: Prisma.BoolWithAggregatesFilter<"Guild"> | boolean
...
export type GuildOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "description" | "isPublic" | "createdAt" | "updatedAt", ExtArgs["result"]["guild"]>
...
export interface GuildFieldRefs {
  ...
  readonly isPublic: Prisma.FieldRef<"Guild", 'Boolean'>
